...
},{"@hyperapp/router":14}],4:[function(require,module,exports) {
...
},{"../../statics/sprite.svg":4,"hyperapp":13}],9:[function(require,module,exports) {
...
},{"../components/ranking-badge":12,"hyperapp":13}],10:[function(require,module,exports) {
...
},{"../components/ranking-badge":12,"hyperapp":13}],11:[function(require,module,exports) {
...
},{"../components/ranking-badge":12,"hyperapp":13}],8:[function(require,module,exports) {
...
},{"./widgets/rank":9,"./widgets/ranks-banner":10,"./widgets/rank-scoring":11,"hyperapp":13}],2:[function(require,module,exports) {
"use strict";function e(e){return e&&e.__esModule?e:{default:e}}var t=require("hyperapp"),r=require("@hyperapp/router"),n=require("./actions"),u=e(n),a=require("./view"),i=e(a),o=require("./widgets/rank"),c=e(o),d=require("./widgets/ranks-banner"),s=e(d),h=require("./widgets/rank-scoring"),l=e(h),f=(0,t.app)({location:r.location.state},u.default,function(e,n){return(0,t.h)(r.Switch,null,(0,t.h)(r.Route,{path:"/",render:function(){return(0,i.default)(e,n)}}),(0,t.h)(r.Route,{path:"/rank",render:function(){return(0,c.default)(e,n)}}),(0,t.h)(r.Route,{path:"/ranks-banner",render:function(){return(0,s.default)(e,n)}}),(0,t.h)(r.Route,{path:"/rank-scoring",render:function(){return(0,l.default)(e,n)}}))},document.body);r.location.subscribe(f.location),f.init(),addEventListener("hashchange",f.init),setInterval(function(){"/"!==location.pathname&&f.refresh()},15e3),function(e){setInterval(function(){document.hidden?document.title="Streamers ❤️ R6":(document.title=e?"Streamers ❤️ R6":"We ❤️ Streamers",e=!e)},1500)}(!1);
},{"./actions":7,"./view":8,"./widgets/rank":9,"./widgets/ranks-banner":10,"./widgets/rank-scoring":11,"hyperapp":13,"@hyperapp/router":14}]},{},[2])